...
public class SinavEklemeGUI extends JFrame {
    ...
    public SinavEklemeGUI() {
        ...
        gbc_3 = new GridBagConstraints();  // Yeni bir GridBagConstraints nesnesi oluştur
        ...
        // Sınav Ekle Butonu
        gbc_7 = new GridBagConstraints();  // Yeni bir GridBagConstraints nesnesi oluştur
        ...
        gbc_4 = new GridBagConstraints();  // Yeni bir GridBagConstraints nesnesi oluştur
